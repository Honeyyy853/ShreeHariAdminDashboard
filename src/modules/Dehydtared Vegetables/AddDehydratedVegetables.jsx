  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-3xl font-bold">Add New Dehydrated Vegetable product</h1>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <Card hover={false}>
            <button onClick={addDehydratedVegetable} disabled={loading} className="btn-primary w-full py-3">
