...
const AddHerbs = () => {
  ...
  const herbNameRef = useRef();
  const herbDescRef = useRef();
  const productCatIdRef = useRef();
  const herbPriceRef = useRef();

  const addHerb = () => {
    const herbName = herbNameRef.current.value;
    const herbDesc = herbDescRef.current.value;
    const herbPrice = herbPriceRef.current.value;
    const productCatId = productCatIdRef.current.value;
    const productImage = imagePreview;

    const formData = new FormData();
    formData.append("productName", herbName);
    formData.append("productDesc", herbDesc);
    formData.append("productPrice", herbPrice);
    ...
    axios
      ...
      .then((response) => {
        console.log("Herb added:", response.data);
        setShowSuccess(true);
        setTimeout(() => navigate("/herbs"), 1500);
      })
      .catch((error) => {
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value={2}>Dehydrated Vegetables</option>
                    <option value={3}>Dehydrated Fruits</option>
                  </select>
          ...
          <div className="space-y-6">
            ...
            <Card hover={false}>
              ...
              {imagePreview ? (
                ...
                <label className="flex flex-col items-center justify-center w-full h-64 border border-dashed rounded-lg cursor-pointer bg-gray-50">
            ...
            <Card hover={false}>
              ...
              <Link
                to="/products"
                className="block w-full text-center btn-secondary py-3 mt-3"
              >
                Cancel
              </Link>
            </Card>
